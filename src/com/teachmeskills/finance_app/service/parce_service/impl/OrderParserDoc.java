...
public class OrderParserDoc implements IParser {
    ...
    public void validatorOrder(SessionManager session){
        if (session.isSessionValid()){
            ...
            String directoryPath = "src/com/teachmeskills/finance_app/resources/data/orders";
    ...
    public double parsingDocument(File fileName) {
        ...
        Pattern pattern = Pattern.compile("Order Total\\s*(\\d+\\.\\d{2})", Pattern.CASE_INSENSITIVE);
